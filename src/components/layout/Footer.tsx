          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 relative">
                <Image
                  src="/images/cable-com-logo-silver.png"
            ...
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/cablecomservices"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/cablecomservices"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary-500 transition-colors"
              ...
              <a
                href="https://www.linkedin.com/company/cable-com-services"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-primary-500 transition-colors"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li className="pt-2">
                ...
                <div className="mt-1 text-white font-semibold">24/7 Emergency Service</div>
              </li>
            </ul>
